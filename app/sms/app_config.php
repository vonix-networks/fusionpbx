<?php
	...
	//default settings
		...
		$apps[$x]['default_settings'][$y]['default_setting_description'] = '';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = 'd37b71b7-880a-5bc7-81ff-670857acd71c';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'sms';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'questblue_api_url';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'text';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = 'https://<pop>.voip.ms/api/v1/rest.php';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'false';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'Questblue SMS send endpoint.';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = '33b7d45e-b122-5b4f-bc91-0fdd8e8d508b';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'sms';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'questblue_username';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'text';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'false';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'Questblue account/sub-account used for the send.';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = '8c0326eb-e311-5eae-9508-01976c2f6343';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'sms';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'questblue_access_key';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'text';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'false';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'Questblue API password, sent as the basic auth password.';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = '4307280a-c7c2-5fb7-9881-f6ec0c55e7c7';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'sms';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'questblue_secret_key';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'text';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'false';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'Questblue Security-Key header value.';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = '8407add4-a269-5af0-87ee-44316a5b9c9c';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'sms';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'bandwidth_username';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'text';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'false';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'Bandwidth applicationId, sent in the message body by the v2 messaging api.';
		$y++;
