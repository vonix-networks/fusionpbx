<?php
	...
	//default settings
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "c7ea661e-639f-55e9-8d18-cfdcbcd46038";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "server";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "project";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Google Cloud project that owns the pub/sub topic and storage buckets.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "a5c51035-a07b-55d8-ab5d-f53bd75a9d54";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "cdr";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "pubsub_topic";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "fusion.cdr.create";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Pub/Sub topic that call detail records are published to.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "f8f79c85-0bd2-5c57-97a2-2d79c5fd1da7";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "pubsub";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "push_audience";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Audience configured on the pub/sub push subscription. Required before pubsub_copy_recording.php will accept a push.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "0dad3214-9384-5e95-8be9-583c8457436b";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "pubsub";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "push_service_account";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Optional. Service account email the push subscription signs with, checked against the token when set.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "93936e3d-fb37-51c0-a851-44a1eb58a459";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "recordings";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "bucket";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Storage bucket that call recordings are copied to.";
		$y++;
